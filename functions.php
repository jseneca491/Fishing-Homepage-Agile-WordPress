...
<?php include_once( get_theme_file_path() . '/wp-essentials.php' );?>   
...
if ( ! class_exists( 'DCTLandscaping_License_Theme' ) ) {
    require_once( get_stylesheet_directory() . '/lib/dctlandscaping-license.php' );
}
if (  class_exists('DCTLandscaping_License_Theme') ) {
     $DCTLandscaping_lib = new DCTLandscaping_License_Theme( __FILE__, '4386059', '1.0.1', 'theme', 'https://divi-childthemes.com/', 'DIVI Landscaping' );
}
/**
